/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 9d19132c3f2be521948ad3f9a636c778)
...
interface __BaseEnv_CloudflareBindings {
	...
	JUPITER_BASE_URL: "https://api.jup.ag" | "https://surfnet-172-93-185-150.sslip.io";
	SUPABASE_URL: "http://127.0.0.1:54321" | "https://yzfrijizuodbpzupfeux.supabase.co" | "https://njegvnneufmbhtsihpuo.supabase.co" | "";
	...
	PYTH_API_KEY: string;
	ENVIRONMENT: string;
	SURFNET_RPC_URL: string;
	CONFIG_PDA: string;
	PROTOCOL_ALT: string;
	APP_ORIGIN: string;
	CORS_ORIGINS: string;
	SIWS_DOMAIN: string;
	ROUTER_ACTOR?: DurableObjectNamespace<import("./src/index").RouterActor>;
	USER_HUB: DurableObjectNamespace<import("./src/index").UserHub>;
	INFLOW_WATCHER?: DurableObjectNamespace<import("./src/index").InflowWatcher>;
	RATE_GATE: DurableObjectNamespace<import("./src/index").RateGate>;
	MARK_BOOK?: DurableObjectNamespace<import("./src/index").MarkBook>;
	RESET_EVERY_HOURS?: "6";
	PRESTOCKS_API_URL?: "https://surfnet-172-93-185-150.sslip.io/prestocks";
	PROOF_SOURCE?: "bundle";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "RouterActor" | "UserHub" | "InflowWatcher" | "RateGate" | "MarkBook";
	}
	interface DemoEnv {
		REGISTRY: KVNamespace;
		EVIDENCE: R2Bucket;
	...
	interface HostedEnv {
		...
		HELIUS_RPC_URL: "";
		ALCHEMY_RPC_URL: "";
		JUPITER_BASE_URL: "https://surfnet-172-93-185-150.sslip.io";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROGRAM_ID" | "USDC_MINT" | "HELIUS_RPC_URL" | "ALCHEMY_RPC_URL" | "JUPITER_BASE_URL" | "SUPABASE_URL" | "PRIVY_APP_ID" | "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT" | "RESEND_FROM" | "TELEGRAM_BOT_USERNAME" | "CRANK_KEY" | "RECORDER_KEY" | "SPONSOR_KEY" | "ATTESTER_KEY" | "OPS_KEY" | "SESSION_SIGNING_KEY" | "VAPID_PRIVATE_KEY" | "HELIUS_WEBHOOK_SECRET" | "TELEGRAM_WEBHOOK_SECRET" | "PARTNER_WEBHOOK_SIGNING_KEY" | "TURNSTILE_SECRET" | "HERMES_URL" | "PYTH_API_KEY" | "ENVIRONMENT" | "SURFNET_RPC_URL" | "CONFIG_PDA" | "PROTOCOL_ALT" | "APP_ORIGIN" | "CORS_ORIGINS" | "SIWS_DOMAIN" | "RESET_EVERY_HOURS" | "PRESTOCKS_API_URL" | "PROOF_SOURCE" | "PUBLIC_RPC_URL">> {}
}
