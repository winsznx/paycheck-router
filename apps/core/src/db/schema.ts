...
export const verifications = pgTable(
  "verifications",
  {
    ...
    finalizedSlot: int64("finalized_slot").notNull(),
    ownerDeltaRaw: int64("owner_delta_raw").notNull(),
    ownerUsdcDelta: int64("owner_usdc_delta").notNull(),
    recomputedMinOut: int64("recomputed_min_out").notNull(),
    recomputedPremiumBps: integer("recomputed_premium_bps").notNull(),
